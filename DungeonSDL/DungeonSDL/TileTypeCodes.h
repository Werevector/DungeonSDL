...
//Try to categorize the TileTypes


//#define TILE_STONEFLOOR = 0;
//#define TILE_GRAVELFLOOR = 1;
//#define TILE_WATER = 2;
//#define TILE_BOARDFLOOR_HORIZONTAL = 3;
//#define TILE_BOARDFLOOR_VERTICAL = 4;
//#define TILE_STATUE = 5;
//#define TILE_WALL_DOWN = 6;
//#define TILE_WALL_LEFT = 7;
//#define TILE_WALL_UP = 8;
//#define TILE_WALL_RIGHT = 9;
